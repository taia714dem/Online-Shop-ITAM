...
export function FilterOptions({options, selectedOption, setSelectedOption }:FilterOptionsProps){
    ...
    const containerStyles={
        width: `${optionsCount==2 ? 210 : 155}px`,
        height: `${optionsCount==2 ? 75 :150}px`,
        marginLeft: `${optionsCount==2 ? 310 : 547}px`
    }
        ...
        const containerStyles2 = {
            ...
            marginLeft:'2px',
            position: 'absolute',
            left: `${optionsCount==2 ? 160 : 378}px`,
            top: 65,
    ...
    return(
        <>
           <div className="FilterOptionsCA" style={isMobile ? containerStyles2: containerStyles}>
                {options.map((option)=>(
